...
let crazyButton = document.querySelector(".crazy");
...
crazyButton.onclick = function() {
    doubleCards.forEach(function(card, index){
         document.getElementById(index).style.postion = "relative";
        if (index % 3 ===0 ){
    document.getElementById(index).style.animation = "dance 10s infinite";
        }
       else if (index% 3 === 1 ){
    document.getElementById(index).style.animation = "dance 5s infinite";
        }
        else {
    document.getElementById(index).style.animation = "dance 8s infinite";
        }
    });
    flipButton.style.color = "silver";                  
};
